...
namespace MyCms3.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Vist,ImageName,ShowInslider,CreateDate,tags")] Page page ,  HttpPostedFileBase imgUp )
        {
            ...
            ViewBag.GroupID = new SelectList(db.GroupPages, "GroupID", "GroupTitle", page.GroupID);
            return View(page);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Vist,ImageName,ShowInslider,CreateDate,tags")] Page page , HttpPostedFileBase imgUp)
        {
            if (ModelState.IsValid)
            {
                if (imgUp != null)
